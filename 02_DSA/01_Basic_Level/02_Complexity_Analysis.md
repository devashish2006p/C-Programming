...
## 2.1 Time Complexity - Ya btata hai algorithm ko complete hone ma kitna time lgega. 
...
## 2.2 Space Complexity - Ya btata hai algorithm ko complete karne ma kitna memory space lgega. 
